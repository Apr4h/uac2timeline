...
VALID_ARTIFACT_TYPES = {"processes", "auth", "cmdhistory", "netconns", "files", "users", "cron"}
...
def _resolve_collection_id(artifact_type: str, artifact_ids: list[int], db: Session) -> int:
    ...
    from uac_parser.models import Process, NetworkConnection, Authentication, CommandHistory, File, User, CronJob
    _MODEL_MAP = {
        "processes":  Process,
